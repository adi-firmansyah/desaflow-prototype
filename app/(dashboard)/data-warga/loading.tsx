  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="h-10 w-36 bg-neutral-200 rounded-md" />
      </div>

      {/* Search + Export */}
      <div className="flex items-center justify-between mb-4 gap-4">
        <div className="h-10 w-full max-w-sm bg-neutral-200 rounded-md" />
        <div className="flex gap-2">
          <div className="h-10 w-24 bg-neutral-200 rounded-md" />
          <div className="h-10 w-24 bg-neutral-200 rounded-md" />
        </div>
      </div>
